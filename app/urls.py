...
urlpatterns = [
    ...
    url(r'formEntrada/', views.form_entrada, name='form_entrada'),
    url(r'consultaEntrada/', views.consulta_entrada, name='consulta_entrada'),
    url(r'formSaida/', views.form_saida, name='form_saida'),
    url(r'consultaSaida/', views.consulta_saida, name='consulta_saida'),
